...
public class ShurikenController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (_TimeCounting > _TimeRandom)
        {
            ...
            gob.transform.rotation = Quaternion.Euler(0f + ZeroPointMove.instance.transform.rotation.eulerAngles.x, 180f + ZeroPointMove.instance.transform.rotation.eulerAngles.y, 0f + ZeroPointMove.instance.transform.rotation.eulerAngles.z);
